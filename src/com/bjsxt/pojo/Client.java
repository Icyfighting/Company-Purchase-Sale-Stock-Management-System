...
public class Client implements Serializable {
	...
	public String toString() {
		return "Client [id=" + id + ", name=" + name + ", sname=" + sname
	...
	public Client(int id, String name, String sname, String address,
			String zipcode, String phone, String fax, String contact,
			String contactPhone, String email, String bank, String accountNumber) {
		this.id = id;
		this.name = name;
		this.sname = sname;
		this.address = address;
