...
<body>
	<div id="father">
		<form id="form" action="insClient" method="post">
										...
										<tr>
											<td height="40">
												<table width="100%" border="0" cellpadding="4"
													...
													<tr>
														<th class="tablestyle_title">客户信息添加</th>
													</tr>
																	...
																	<td width="100%">
																		<fieldset style="height:100%;">
																			...
																			<table border="0" cellpadding="2" cellspacing="1"
																				style="width:100%">
																				<input type="hidden" name="method" value="insClient" />
																				<tr>
																					<td>客户全称 :</td>
																				...
																				<tr>
																					<td>客户简称:</td>
																					<td><input class="text" name='sname'
																						style="width:500px" value="" /></td>
																				</tr>
																				<tr>
																					<td>邮政编码:</td>
																					<td><input class="text" name='zipcode'
																						style="width:500px" value="" /></td>
																				</tr>
																				<tr>
																					<td>电话:</td>
																				...
																				<tr>
																					<td>传真:</td>
																					<td><input class="text" name='fax'
																						style="width:500px" value="" /></td>
																				</tr>
																				<tr>
																					<td>联系人:</td>
																					<td><input class="text" name='contact'
																						style="width:500px" value="" /></td>
																				</tr>
																				<tr>
																					<td>联系电话:</td>
																					<td><input class="text" name='contactPhone'
																						style="width:500px" value="" /></td>
																				</tr>
																				<tr>
																					<td>E-mail:</td>
																				...
																				<tr>
																					<td>开户银行:</td>
																					<td><input class="text" name='bank'
																						style="width:500px" value="" /></td>
																				</tr>
																				<tr>
																					<td>银行账号:</td>
																					<td><input class="text" name='accountNumber'
																						style="width:500px" value="" /></td>
																				</tr>
																				<!-- <tr>
																				<td>客户简述:</td>
